...
document.getElementById("proximo").addEventListener("click", function() {
  ...
  BtnVoltar.onclick = ()=>{
    formContainerResumo.classList.toggle('hidden');
...
document.getElementById('proximo').addEventListener('click', function() {
    ...
    const nome = document.getElementById('text_nome').value;
    const zap = document.getElementById('tel_zap').value;
    const categoria = document.getElementById('op-categoria').value;
    const data = document.getElementById('date_data').value;
    const pessoa = document.getElementById('text_pessoa').value;
