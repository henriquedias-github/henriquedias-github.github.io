...
// Variável que vai controlar o valor dentro da div com id "add"
let valor = 0;

// Seleciona as divs pelos seus IDs
...
// Função para atualizar o valor na div "add" e "unit"
function atualizarAdd() {
    addDiv.textContent = valor;
    unitDiv.textContent = valor;
    atualizarSubPrice();
}

// Função para atualizar o valor da div "sub_price" e "total_price"
function atualizarSubPrice() {
    const subPrice = parseInt(subPriceDiv.textContent);
    const novoSubPrice = valor * subPrice; // Multiplica o valor da unit pelo sub_price
    subPriceDiv.textContent = novoSubPrice;
    totalPriceDiv.textContent = novoSubPrice; // Atualiza também o total_price
}

// Evento para o botão de subtração (div com id "minus")
...
// Evento para o botão de adição (div com id "plus")
...
// // Função para atualizar o valor na div "add"
// function atualizarAdd() {
//     addDiv.textContent = valor;
// }
