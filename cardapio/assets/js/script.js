...
window.addEventListener('load', function() {
    ...
    // Verifica se a chave 'Cestinha' existe no localStorage
    let valorCestinha = localStorage.getItem('cestinha');

    // Verifica se a chave 'Cestinha' tem valor igual a 'ativa'
    if (valorCestinha === 'ativa') {
        console.log('A Cestinha está ativa!'); // Mensagem quando o valor for 'ativa'
 
    } else {
        console.log('A Cestinha está vazia ou não foi encontrada.'); // Mensagem se não for 'ativa' ou estiver vazia
